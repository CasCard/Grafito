...
int NewSetpoint;
double MaxChange = 1000;  // maximum change in setpoint per second
double TimeInterval = 20;  // time interval in milliseconds
...
extern "C" void app_main() {
  ...
  xTaskCreate(motorTask, "motorTask", 7000, NULL, 1, NULL);
